    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400">Manage your product suppliers.</p>
        </div>
        <button 
      ...
      <ConfirmModal 
        ...
        onConfirm={() => deletingId && deleteSupplier(deletingId)}
        title="Delete Supplier"
        message="Are you sure you want to delete this supplier? This will not delete products from this supplier, but they will no longer have a linked supplier."
        confirmText="Delete"
      />
